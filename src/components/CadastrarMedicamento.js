    ...
    return (
        <div className="CadastrarMedicamento">
            ...
            <form onSubmit={onSubmitGravarMedicmentoHandler}>
                ...
                <label>Dosagem: <input type="text" name="dosagem" placeholder="Digite a dosagem do remédio" value={dosagem} onChange={(event) => setDosagem(event.target.value)} required /> </label>
                <label>Prescrição: <input type="text" name="prescricao" placeholder="Digite a prescicao do remédio" value={prescricao} onChange={(event) => setPrescricao(event.target.value)} /> </label>
                <label>Laboratório: <input type="text" name="laboratorio" placeholder="Digite o laboratorio do remédio" value={laboratorio} onChange={(event) => setLaboratorio(event.target.value)} /> </label>
                <div>
